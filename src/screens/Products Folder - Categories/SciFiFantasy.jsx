...
export default function SciFiFantasy() {
        ...
        <div className='products'>
            <div className='grid'>
                ...
                <section className="sidebar" id="up">
                    ...
                    <NavLink to="/products/sci-fi-and-fantasy" className={"side-bar-active"}>Science Fiction and Fantasy</NavLink>

                </section>

                <ProductsPage title={"Science Fiction and Fantasy"} tagdata={"SciFiFantasy"}/>
