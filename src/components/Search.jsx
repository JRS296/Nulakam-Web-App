...
export default function Search() {
    ...
    const [query, setQuery] = useState(queryParameters.get("query") ? queryParameters.get("query") : "");
            ...
            <div className='grid'>
                ...
                <section className="sidebar" id="up">
                    ...
                    <div className="pro-cat">
                        ...
                        <div style={{padding: '10px 8px 0px 8px', color: '#E35508'}}>Genres</div>

                        <NavLink to="/products">All Products</NavLink>
                        <NavLink to="/products/business-and-economics">Business and Economics</NavLink>
                        ...
                        <div className="border-side"></div>
                        <div style={{padding: '10px 8px 0px 8px', color: '#E35508'}}>Authors</div>

                        <div className="border-side"></div>
                        <div style={{padding: '10px 8px 0px 8px', color: '#E35508'}}>Year</div>

                        <div className="border-side"></div>
                        <div style={{padding: '10px 8px 0px 8px', color: '#E35508'}}>Publishers</div>
                ...
                <ProductsPage title={"Search Results for '" + query + "'"} querydata={query} />
